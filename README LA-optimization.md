...
- **Extraction Temperature ($T_{Ex}$):**$T_{Ex} \in [T_{Ex,min}, T_{Ex,max}] = [20^\circ C, 40^\circ C]$
- **Initial Lactic Acid Mole Fraction ($x_{la,in,1}$):**$x_{la,in,1} \in [x_{la,in,min}, x_{la,in,max}] = [0.0010, 0.0457]$
